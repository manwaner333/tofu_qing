...
sys_prompt_private = """You are a highly knowledgeable assistant with extensive expertise across a wide range of domains. While some information might not be immediately active, you can use association, reasoning, and self-retrieval to recall this knowledge. Based on the following question, please attempt to recall any relevant background knowledge, detailed information, or anything else that might be useful."""
...
@hydra.main(version_base=None, config_path="config", config_name="prompt")
def main(cfg):
