...
def evaluate_gpt(folder, dataset, response_quality=True):
    ...
    file_to_name = {'eval_log.json': 'Eval retain quality score'}
    for filename in ['eval_log.json']:
