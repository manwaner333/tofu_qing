...
class ModelHelper:
    def __init__(self, args):
        ...
        self.model = AutoModelForCausalLM.from_pretrained(args.model_path, torch_dtype=torch.float16, use_flash_attention_2=True, trust_remote_code=True).to(self.device)
